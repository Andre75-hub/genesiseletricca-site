...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const posts = [
        {
            title: "Disjuntores: fundamentos e aplicações em sistemas elétricos",
            url: "disjuntor.html",
            summary: "Aprenda sobre os disjuntores, sua importância na segurança e os tipos utilizados em instalações elétricas residenciais e industriais."
        },
        {
            title: "Entenda o IDR e sua importância na proteção elétrica",
            url: "idr.html",
            summary: "Conheça o Interruptor Diferencial Residual (IDR), um dispositivo de segurança essencial para proteger contra choques e fugas de corrente."
        }
    ];

    // 1. Código para rolagem suave para links de âncora na navegação
    ...
    // 2. Código para envio do formulário de comentários sem recarregar a página
